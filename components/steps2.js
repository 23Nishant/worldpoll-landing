                  ...
                  {props.step1Description ?? (
                    <Fragment>
                      <span className="steps2-text31 thq-body-small">
                        Provide a clear and concise topic or question for your
                        poll.
                      </span>
                    </Fragment>
                  )}
                  ...
                  {props.step2Description ?? (
                    <Fragment>
                      <span className="steps2-text32 thq-body-small">
                        Enter the two options that participants can choose from
                        in your poll.
                      </span>
                    </Fragment>
                  )}
                  ...
                  {props.step3Description ?? (
                    <Fragment>
                      <span className="steps2-text26 thq-body-small">
                        Click the &apos;Create Poll&apos; button to add your
                        poll to the list below.
                      </span>
                    </Fragment>
                  )}
                </span>
                  ...
                  {props.step4Description ?? (
                    <Fragment>
                      <span className="steps2-text28 thq-body-small">
                        Scroll down to see the list of existing polls you have
                        created.
                      </span>
                    </Fragment>
                  )}
